// Board B: I2C1 slave — text message receiver + UART display
// SCL: D15 (PTE1), SDA: D14 (PTE0), ALT6
// Receives packets from master at address 0x48, prints messages over UART0
// Packet format: [0xAA][len][ascii bytes...]
// Compile with: BOARD_B_TEXT
...
int main(void)
{
    ...
    uart_puts("Board B ready — waiting for text messages on address 0x48\r\n");
